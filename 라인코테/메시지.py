...
# num, consumer = map(int, input().split())
# dic = {}
...
# for i in range(num):
#     time = int(input())
#     my_min = 10000000000000000000000000000
#     min_key = 0
...
for _ in range(M):
   ...
   min_num = min(consum_list)
   i = consum_list.index(min_num)
   consum_list[i] += new_message
result = max(consum_list)
print(result)